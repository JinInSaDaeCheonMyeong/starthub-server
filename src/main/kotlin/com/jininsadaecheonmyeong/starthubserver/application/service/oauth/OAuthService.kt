package com.jininsadaecheonmyeong.starthubserver.application.service.oauth
...
class OAuthService(
    ...
    override fun naverAuthApp(code: String) = processOAuthLogin(naverService.exchangeCodeForUserInfoApp(code), AuthType.NAVER)

    override fun appleAuthApp(idToken: String) = processOAuthLogin(appleService.exchangeCodeForUserInfoApp(idToken), AuthType.APPLE)
