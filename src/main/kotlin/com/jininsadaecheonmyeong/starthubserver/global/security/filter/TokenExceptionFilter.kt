...
class TokenExceptionFilter : OncePerRequestFilter() {
    ...
    override fun doFilterInternal(
        ...
        try {
            ...
            handleTokenException(response, HttpStatus.UNAUTHORIZED, "EXPIRED_TOKEN", e.message)
        } catch (e: InvalidTokenException) {
            log.error("Invalid token", e)
            handleTokenException(response, HttpStatus.UNAUTHORIZED, "INVALID_TOKEN", e.message)
