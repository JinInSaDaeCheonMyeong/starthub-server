package com.jininsadaecheonmyeong.starthubserver.controller.recruit

import com.jininsadaecheonmyeong.starthubserver.docs.recruit.RecruitDocs
...
class RecruitController(
    ...
    override fun createRecruit(
        ...
        return BaseResponse.of(recruitUseCase.createRecruit(request), "채용 공고 생성 성공")
    }
    ...
    override fun updateRecruit(
        ...
        return BaseResponse.of(recruitUseCase.updateRecruit(id, request), "채용 공고 수정 성공")
    }
    ...
    override fun deleteRecruit(
        ...
        return BaseResponse.of(recruitUseCase.deleteRecruit(id), "채용 공고 삭제 성공")
    }
    ...
    override fun closeRecruit(
        ...
        return BaseResponse.of(recruitUseCase.closeRecruit(id), "채용 공고 마감 성공")
    }
    ...
    override fun getRecruit(
        ...
        return BaseResponse.of(recruitUseCase.getRecruit(id), "채용 공고 상세 조회 성공")
    }
}
